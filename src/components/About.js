    ...
    return (
      <div className="aboutContent">
        ...
        <p className="paragraphs">
          Copenhagen based autodidact software developer. I prefer to work with
          web and mobile technologies, but don’t always get to choose. Would
          rather shoot myself than read a book about software development.
        </p>
        <hr></hr>
        <h3 className="headline">Privately</h3>
        <p className="paragraphs">
          Live with my French boyfriend and our two daughters. I love to dance
          and hate not getting my 8 hours of sleep. My general knowledge is
          incredibly bad but am good at pretending I know what people are
          talking about.
        </p>
        {/*<hr></hr>
